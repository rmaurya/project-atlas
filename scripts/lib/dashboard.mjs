...
function signalCataloguePanel(health, cfg) {
  ...
  <p class="cap">Kept apart because ${operator.length === 1 ? 'it measures' : 'these measure'}
    <strong>the operator, not the corpus</strong>. Every signal above is a claim about the documents in this repository and
